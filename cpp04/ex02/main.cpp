...
int main() {
	...
	Cat c; c.setBrain(0, "climb curtain");
	...
	c.setBrain(0, "scrach everyone");
	std::cout << "c.idea[0] = " << c.getBrainIdea(0) << std::endl;
	std::cout << "d.idea[0] = " << d.getBrainIdea(0)  << std::endl;

	std::cout << std::endl << "~~~~~ Dog Ideas turn ~~~~~" << std::endl << std::endl;

	std::cout << "Dog f brain[0] set to: climb curtain" << std::endl;
	Dog f; f.setIdeas(0, "climb curtain");
	...
	f.setIdeas(0, "scrach everyone");
	std::cout << "f.idea[0] = " << f.getIdea(0) << std::endl;
	std::cout << "g.idea[0] = " << g.getIdea(0) << std::endl;
